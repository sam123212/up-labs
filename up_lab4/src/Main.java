...
public class Main extends JFrame 
{
	...
	{
        initComponents();
        this.setTitle("Четырёхлепестковая роза");
    ...
    private void initComponents() 
    {
        ...
        {     
            ...
            public void paintComponent(Graphics g) 
			{
                ...
                g1.drawString("Четырёхлепестковая роза", getX() + getWidth() / 2 - 30, getY() + getHeight() - 50);
            }
        }
        ;
    ...
    {      
        ...
        try
        {
            hw = new HardcopyWriter("Четырёхлепестковая роза", 14, .75, .75, .75, .75);
