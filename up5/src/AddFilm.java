...
public class AddFilm extends JFrame {
    ...
    private void initComponents() {
        ...
        typeLabel.setText("Год выпуска: ");
        speciesLabel.setText("Жанр фильма: ");
        colorLabel.setText("Режиссёр: ");
        ...
        numberLabel.setText("Название фильма:");
