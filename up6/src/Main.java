        ...
        MouseMotionListener // For processing mouse drags
{
    ...
    private ArrayList<Graph> witches = new ArrayList();
    // A list of Scribbles to draw
    private Graph currentScribble; // The scribble in progress
    private Graph beingDragged; // The scribble being dragged
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.setStroke(new Str(2f)); // Specify wide lines

        for (Graph witch : witches) {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        currentScribble = new Graph(param, e.getX(), e.getY());
    ...
    public void dragGestureRecognized(DragGestureEvent e) {
        ...
        for (Graph witch : witches) { // Loop through the scribbles
            if (witch.intersects(rectangle)) {
                ...
                Graph dragScribble = (Graph) witch.clone();
    ...
    public void dragEnter(DropTargetDragEvent e) {
        if (e.isDataFlavorSupported(Graph.decDataFlavor) || e.isDataFlavorSupported(DataFlavor.stringFlavor)) {
    ...
    public void drop(DropTargetDropEvent e) {
        ...
        Graph droppedScribble; // This will hold the Scribble object

        // First, try to get the data directly as a scribble object
        try {
            droppedScribble = (Graph) t.getTransferData(Graph.decDataFlavor);
            ...
            try {
                ...
                droppedScribble = Graph.getFromString(s);
            } catch (Exception ex2) {
